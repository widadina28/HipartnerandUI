...
interface AuthApiService {
    ...
    fun postHire(@Field("id_project") id_project: String?,
                 ...
                 @Field("confirm_date") confirm_date: String?) : Call<HireResponse>

    @Multipart
    @PUT("company/{id}")
    fun putCompany(@Path("id")id:String?,
                   ...
                   @Part("idacc") id_account: RequestBody) : Call<Void>

    @Multipart
    @PUT("project/{id}")
    fun putProject(@Path("id")id:String?,
                     ...
                     @Part("price") price: RequestBody) : Call<Void>

    @Multipart
    @POST("company")
    fun companyRequest(@Part("name_company") nameCompany: RequestBody,
                       @Part("field") field: RequestBody,
                       @Part("position") position: RequestBody,
                       @Part("id_loc") idLoc: RequestBody,
                       ...
                       @Part("idacc") idacc: RequestBody) : Call<CompanyResponse>

    @Multipart
    @POST("project")
    fun postProject (@Part("project_name") project_name: RequestBody,
                       @Part("description") description: RequestBody,
                       @Part("deadline") deadline: RequestBody,
                       @Part("id_company") id_company: RequestBody,
                       @Part("price") price: RequestBody,
                       @Part image: MultipartBody.Part?) : Call<PostProjectResponse>
    ...
    @GET("engineer")
    suspend fun getEngineerForSearch(@Query("limit") limit: Int?, @Query("search") search:String?) : EngineerResponse
