...
class ProjectAdapter(var dcProject:ArrayList<ProjectAllModel>, var listener: OnAdapterListener):RecyclerView.Adapter<ProjectAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        Picasso.get().load("http://3.80.45.131:8080/uploads/" + project.image).placeholder(R.drawable.ic_image_editing).into(holder.view.image_project)
